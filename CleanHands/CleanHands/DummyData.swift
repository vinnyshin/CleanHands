...
var sars = Pathogen(type: .virus, name: "사스 바이러스", exp: 20, description: "제 3 위험군\n고위험병원체, 생물작용제, 전략물자통제병원체\nCoronaviridae과, Betacoronavirus속, (+)ssRNA 바이러스, 피막 있음, 왕관모양", illnesses: [], symptom: "중증 급성 호흡기 증후군(SARS)을 유발\n 초기에는 감기와 비슷한 증상, 2~7일 후에 마른 헛기침, 호흡 곤란 또는 저산소증과 같은 호흡기 증상", careMethod: "항바이러스제는 없으며, 환자 상태에 따라 대증치료, 유효한 백신 없음", location: "주로 호흡기 비말을 통해 감염됨. 감염자와의 밀접한 접촉이나 감염자의 인체 분비액이 눈, 코, 입 등의 점막에 직접 또는 간접적으로 접촉되는 경우 감염", frequency: Frequency.low, image: "SARS.png", requiredAchievements: [achievement_corona])
...
var achievement_zika = Achievement(name: "모기 매개 병원체 퇴치", description: "지카 바이러스 50000마리 퇴치", completeConditions: [zikaVirus:50000], appearConditions: [achievement_corona], id: 6)
var achievement_sars = Achievement(name: "유전자가 86% 일치하는 두 바이러스", description: "사스 바이러스 50000마리, 코로나 바이러스 120000마리 퇴치", completeConditions: [sars:50000, coronaVirus:120000], appearConditions: [achievement_corona], id: 7)
...
var achievementList:[Achievement] = [achievement_lassa, achievement_polio3, achievement_polio, achievement_danger3, achievement_zika, achievement_sars, achievement_corona, achievement_esch2, achievement_sal, achievement_noro, achievement_esch, achievement_esch3, achievement_polio2, achievement_danger4, achievement_tutorial]
