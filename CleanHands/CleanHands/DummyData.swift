...
var achievement1 = Achievement(name: "대장균 퇴치 1", description: "대장균 50마리 퇴치", completeConditions: [escherichiaCoil:50], appearConditions: [], id: 0)
...
var achievement4 = Achievement(name: "제 4 위험군 퇴치 1", description: "에볼라 바이러스, 라싸 바이러스 30마리 퇴치", completeConditions: [ebolaVirus:30, lassaVirus:30], appearConditions: [], id: 3)
...
var achievement6 = Achievement(name: "모기 매개 병원체 퇴치", description: "지카 바이러스 50마리 퇴치", completeConditions: [zikaVirus:50], appearConditions: [], id: 5)
...
var achievementList:[Achievement] = [achievement1, achievement2, achievement3, achievement4, achievement5, achievement6]
