...
func loadUser() -> User{
    ...
    return User(name: "initName", pathogenDic: [:], washDataList: randomWashList, handState: HandState(lastWashTime: Date(), pathogenAmount: 0), exp: 0, isAlarmOn: false, isDoNotDisturbOn: false, doNotDisturbFrom: nil, doNotDisturbTo: nil, repeatTime: "2시간")
}
